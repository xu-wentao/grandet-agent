...
func TestTelemetryStartIsAtomicAndCrashSafe(t *testing.T) {
	...
	run := domain.BaselineRun{SessionID: "session-1", TrajectoryID: "trajectory-1", TaskID: "task-1", StepID: "step-1", ProfileID: "fixed", PolicyVersion: "stingy-v1", PromptHash: "hash", StartedAt: started}
